import { type FinalizedTxData, type MidnightProviders, type PrivateStateKey, type PrivateStateSchema, type VerifierKey } from '@midnight-ntwrk/midnight-js-types';
 ...
 */
export declare const submitInsertVerifierKeyTx: <PSS extends PrivateStateSchema, PSK extends PrivateStateKey<PSS>>(providers: MidnightProviders, privateStateKey: PSK, contractAddress: ContractAddress, circuitId: ImpureCircuitId, newVk: VerifierKey) => Promise<FinalizedTxData>;
