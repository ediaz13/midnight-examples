import type { FinalizedTxData, MidnightProviders, PrivateStateKey, PrivateStateSchema, VerifierKey } from '@midnight-ntwrk/midnight-js-types';
import type { ContractAddress } from '@midnight-ntwrk/ledger';
import type { SigningKey } from '@midnight-ntwrk/compact-runtime';
import { type CircuitParameters, type Contract, type ImpureCircuitId } from './contract-model';
 ...
 */
export type CircuitCallTxInterface<PS, C extends Contract<PS>> = {
    [ICK in ImpureCircuitId<C>]: (...args: CircuitParameters<C, ICK>) => Promise<FinalizedCallTxData<PS, C, ICK>>;
};
/**
 * Creates a {@link CallTxOptions} object from various data.
 */
export declare const createCallTxOptions: <PSS extends PrivateStateSchema, PSK extends PrivateStateKey<PSS>, C extends Contract<PSS[PSK]>, ICK extends ImpureCircuitId<C>>(contract: C, circuitId: ICK, contractAddress: ContractAddress, privateStateKey: PSK, args: CircuitParameters<C, ICK>) => CallTxOptions<PSS, PSK, C, ICK>;
/**
 ...
 */
export declare const createCircuitCallTxInterface: <PSS extends PrivateStateSchema, PSK extends PrivateStateKey<PSS>, C extends Contract<PSS[PSK]>>(providers: MidnightProviders<ImpureCircuitId<C>, PSS>, contract: C, contractAddress: ContractAddress, privateStateKey: PSK) => CircuitCallTxInterface<PSS[PSK], C>;
/**
 ...
 */
export declare const createCircuitMaintenanceTxInterface: <PSS extends PrivateStateSchema, PSK extends PrivateStateKey<PSS>, C extends Contract, ICK extends ImpureCircuitId<C>>(providers: MidnightProviders<ImpureCircuitId<C>>, circuitId: ICK, privateStateKey: PSK, contractAddress: ContractAddress) => CircuitMaintenanceTxInterface;
/**
 ...
 * @param contractAddress The ledger address of the contract.
 */
export declare const createCircuitMaintenanceTxInterfaces: <PSS extends PrivateStateSchema, PSK extends PrivateStateKey<PSS>, C extends Contract>(providers: MidnightProviders<ImpureCircuitId<C>>, contract: C, privateStateKey: PSK, contractAddress: ContractAddress) => CircuitMaintenanceTxInterfaces<C>;
/**
 ...
 * @param contractAddress The ledger address of the contract.
 */
export declare const createContractMaintenanceTxInterface: <PSS extends PrivateStateSchema, PSK extends PrivateStateKey<PSS>>(providers: MidnightProviders, privateStateKey: PSK, contractAddress: ContractAddress) => ContractMaintenanceTxInterface;
