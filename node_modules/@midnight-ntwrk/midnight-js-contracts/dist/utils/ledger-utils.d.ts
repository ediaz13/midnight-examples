...
export declare const createUnprovenLedgerDeployTx: (verifierKeys: [ImpureCircuitId, VerifierKey][], sk: SigningKey, contractState: ContractState, zswapLocalState: ZswapLocalState) => [ContractAddress, ContractState, UnprovenTransaction];
export declare const createUnprovenLedgerCallTx: (circuitId: ImpureCircuitId, contractAddress: ContractAddress, initialContractState: ContractState, zswapChainState: ZswapChainState, partitionedTranscript: PartitionedTranscript, privateTranscriptOutputs: AlignedValue[], input: AlignedValue, output: AlignedValue, nextZswapLocalState: ZswapLocalState) => UnprovenTransaction;
