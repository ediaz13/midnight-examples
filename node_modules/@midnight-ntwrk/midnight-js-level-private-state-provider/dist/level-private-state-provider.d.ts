 ...
 */
export declare const levelPrivateStateProvider: <PSS extends PrivateStateSchema>(partialConfig?: Partial<LevelPrivateStateProviderConfig>) => PrivateStateProvider<PSS>;
