...
const toLedgerNetworkId = (id) => {
    switch (id) {
        ...
        default:
            throw new Error(`Unexpected network id: ${id}`);
    }
};
...
const networkIdToHex = (networkId) => {
    switch (networkId) {
        ...
        case NetworkId.MainNet:
            return '04';
        default:
            throw new Error(`Unexpected network ID: ${networkId}`);
    }
};

export { NetworkId, getLedgerNetworkId, getNetworkId, getRuntimeNetworkId, getZswapNetworkId, networkIdToHex, setNetworkId, stringToNetworkId };
