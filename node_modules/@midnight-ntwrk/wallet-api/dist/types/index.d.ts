import type { CoinInfo, EncPublicKey, QualifiedCoinInfo, Transaction, UnprovenTransaction } from '@midnight-ntwrk/zswap';
/**
 ...
 *
 * @remarks
 * How many indices were processed (synced) versus how many are known to be
 * finalized in the blockchain.
 */
export type SyncProgress = {
    /**
     * Block height up to where the wallet has synced so far
     */
    readonly synced: bigint;
    /**
     * Max known block height
     */
