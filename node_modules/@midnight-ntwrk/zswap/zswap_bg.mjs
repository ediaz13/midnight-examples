...
function __wbg_adapter_347(arg0, arg1, arg2, arg3, arg4) {
    wasm.closure590_externref_shim(arg0, arg1, arg2, arg3, arg4);
}
...
export class ProofErasedTransaction {
    ...
    */
    imbalances(guaranteed, fees) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.prooferasedtransaction_imbalances(retptr, this.__wbg_ptr, guaranteed, !isLikeNone(fees), isLikeNone(fees) ? BigInt(0) : fees);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    constructor(guaranteed, fallible) {
        try {
            ...
            wasm.unproventransaction_new(retptr, guaranteed.__wbg_ptr, fallible);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export function __wbg_forEach_7f750c3c9a95bff9(arg0, arg1, arg2) {
    try {
        ...
        var cb0 = (arg0, arg1, arg2) => {
            ...
            state0.a = 0;
            try {
                return __wbg_adapter_347(a, state0.b, arg0, arg1, arg2);
            } finally {
                state0.a = a;
            }
        };
